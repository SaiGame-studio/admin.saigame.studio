 ...
 */
export async function unsubscribeFromPlugin(gameId: string, pluginId: string): Promise<void> {
 ...
 */
export async function subscribeToPlugin(gameId: string, pluginId: string, stacks: number = 1): Promise<GamePluginSubscription> {
 ...
 */
export function getRemainingStacks(plugin: Plugin, subscriptions: GamePluginsResult["subscriptions"]): number {
