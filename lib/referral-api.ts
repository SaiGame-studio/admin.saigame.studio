...
export async function getReferralCodes(params?: { limit?: number; offset?: number }): Promise<ReferralCodesResponse> {
...
export async function updateReferralCode(codeId: string, payload: { is_active: boolean }): Promise<ReferralCode> {
