...
export async function createScript(gameId: string, body: CreateScriptRequest): Promise<GameScript> {
...
export async function updateScript(gameId: string, scriptId: string, body: UpdateScriptRequest): Promise<GameScript> {
