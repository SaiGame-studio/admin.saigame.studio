 ...
 */
export async function createTeam(studioId: string, teamData: {
    name: string;
    description?: string;
}): Promise<Team> {
 ...
 */
export async function addMemberToTeam(teamId: string, userId: string, roleId: string): Promise<TeamMember> {
 ...
 */
export async function updateMemberRole(teamId: string, memberId: string, roleId: string): Promise<TeamMember> {
 ...
 */
export async function assignGamesToTeam(teamId: string, gameIds: string[]): Promise<void> {
 ...
 */
export async function unassignGameFromTeam(teamId: string, gameId: string): Promise<void> {
