...
import type { EntityDefinition, EntityType, CreateEntityDefinitionRequest, UpdateEntityDefinitionRequest, EntityPool, EntityPoolEntry, CreateEntityPoolRequest, UpdateEntityPoolRequest, CreateEntityPoolEntryRequest, } from '@/types/entity-definition';
...
export async function createEntityDefinition(gameId: string, body: CreateEntityDefinitionRequest): Promise<EntityDefinition> {
    return api.post(`/api/v1/games/${gameId}/entity-definitions`, body);
}
/** GET /api/v1/games/:gameId/entity-definitions */
export async function listEntityDefinitions(gameId: string, params: ListEntityDefinitionsParams = {}): Promise<EntityDefinition[]> {
...
export async function getEntityDefinition(gameId: string, entityDefId: string): Promise<EntityDefinition> {
...
export async function getEntityDefinitionByKey(gameId: string, entityDefKey: string): Promise<EntityDefinition> {
...
export async function updateEntityDefinition(gameId: string, entityDefId: string, body: UpdateEntityDefinitionRequest): Promise<EntityDefinition> {
...
export async function deleteEntityDefinition(gameId: string, entityDefId: string): Promise<void> {
...
export async function getEntityDefinitionTypes(): Promise<string[]> {
    const res = await api.get('/api/v1/entity-definitions/types') as {
        entity_types: string[];
    };
    return res.entity_types;
}
/** POST /api/v1/games/:gameId/entity-definitions/bulk */
export async function bulkGetEntityDefinitions(gameId: string, keys: string[]): Promise<EntityDefinition[]> {
...
export async function createEntityPool(gameId: string, body: CreateEntityPoolRequest): Promise<EntityPool> {
...
export async function updateEntityPool(gameId: string, id: string, body: UpdateEntityPoolRequest): Promise<EntityPool> {
...
export async function createEntityPoolEntry(gameId: string, poolId: string, body: CreateEntityPoolEntryRequest): Promise<EntityPoolEntry> {
...
export async function updateEntityPoolEntry(gameId: string, poolId: string, entryId: string, body: {
    weight: number;
...
export async function deleteEntityPoolEntry(gameId: string, poolId: string, entryId: string): Promise<void> {
