 ...
 */
export function isInventoryType(itemProfile: {
    type: string;
}): boolean {
 ...
 */
export function isLootboxType(itemProfile: {
    type: string;
}): boolean {
 ...
 */
export function isRngLootboxType(itemProfile: {
    type: string;
}): boolean {
 ...
 */
export function supportsProperties(itemProfile: {
    type: string;
}): boolean {
 ...
 */
export function getAvailableTabs(itemProfile: {
    type: string;
}): ItemProfileTab[] {
