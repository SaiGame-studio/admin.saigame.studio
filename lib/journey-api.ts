...
export async function updateJourney(gameId: string, journeyId: string, body: UpdateJourneyRequest): Promise<Journey> {
...
export async function saveJourneyDag(gameId: string, journeyId: string, body: SaveJourneyDagRequest): Promise<JourneyDag> {
...
export async function createNodeDefinition(gameId: string, body: CreateNodeDefinitionRequest): Promise<JourneyDagNodeDefinition> {
    return api.post(`/api/v1/games/${gameId}/journey-node-definitions`, body);
}
export async function updateNodeDefinition(gameId: string, nodeDefId: string, body: UpdateNodeDefinitionRequest): Promise<JourneyDagNodeDefinition> {
...
export async function addNodeToJourney(gameId: string, journeyId: string, body: AddNodeToJourneyRequest): Promise<JourneyDagNode> {
...
export async function getEventStats(gameId: string, params?: {
    from?: string;
    to?: string;
    event_type?: string;
