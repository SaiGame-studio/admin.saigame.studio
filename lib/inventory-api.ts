...
import type { ItemDefinition, CreateItemRequest, UpdateItemRequest, GachaPack, GachaPoolEntry, GachaPackResult, CreateGachaPackRequest, UpdateGachaPackRequest, InventoryTransaction, Paginated, ItemCategory, ItemRarity, TxType, ContainerDefinition, ContainerType, CreateContainerDefinitionRequest, UpdateContainerDefinitionRequest, EquipmentSlot, } from '@/types/inventory';
...
export async function createItemDefinition(ctx: TenantCtx, body: CreateItemRequest): Promise<{
    item: ItemDefinition;
}> {
...
export async function listItemDefinitions(ctx: TenantCtx, params: ListItemsParams = {}): Promise<Paginated<ItemDefinition>> {
    ...
    if (params.item_code)
        qs.set('item_code', params.item_code);
    if (params.tags && params.tags.length > 0)
        qs.set('tags', params.tags.join(','));
    if (params.allow_client_update_qty != null)
        qs.set('allow_client_update_qty', String(params.allow_client_update_qty));
...
export async function getItemDefinition(ctx: TenantCtx, itemId: string): Promise<{
    item: ItemDefinition;
}> {
    return api.get(`/api/v1/games/${ctx.gameId}/items/${itemId}`);
}
/** PATCH /api/v1/games/:gameId/items/:itemId — Update an item definition */
export async function updateItemDefinition(ctx: TenantCtx, itemId: string, body: UpdateItemRequest): Promise<{
    item: ItemDefinition;
}> {
...
export async function deleteItemDefinition(ctx: TenantCtx, itemId: string): Promise<{
    message: string;
}> {
...
export async function listGachaPacks(ctx: TenantCtx, params?: {
    code_name?: string;
    limit?: number;
    offset?: number;
}): Promise<{
    ...
    const qs = new URLSearchParams();
    if (params?.code_name)
        qs.set('code_name', params.code_name);
...
export async function getGachaPack(ctx: TenantCtx, packId: string): Promise<{
    pack: GachaPack;
}> {
    return api.get(`/api/v1/games/${ctx.gameId}/gacha/packs/${packId}`);
}
/** POST /api/v1/games/:gameId/gacha/packs — Create a gacha pack */
export async function createGachaPack(ctx: TenantCtx, body: CreateGachaPackRequest): Promise<{
    pack: GachaPack;
}> {
    return api.post(`/api/v1/games/${ctx.gameId}/gacha/packs`, body);
}
/** PATCH /api/v1/games/:gameId/gacha/packs/:packId — Update a gacha pack */
export async function updateGachaPack(ctx: TenantCtx, packId: string, body: UpdateGachaPackRequest): Promise<{
    pack: GachaPack;
}> {
...
export async function deleteGachaPack(ctx: TenantCtx, packId: string): Promise<{
    message: string;
}> {
...
export async function setGachaPackEnabled(ctx: TenantCtx, packId: string, isEnabled: boolean): Promise<{
    is_enabled: boolean;
}> {
    return api.patch(`/api/v1/games/${ctx.gameId}/gacha/packs/${packId}/enabled`, { is_enabled: isEnabled });
}
/** POST /api/v1/games/:gameId/gacha/open — Open a gacha pack (requires idempotency key) */
export async function openGachaPack(ctx: TenantCtx, packType: string, idempotencyKey: string): Promise<GachaPackResult> {
    return api.post(`/api/v1/games/${ctx.gameId}/gacha/open`, { pack_type: packType }, { headers: { 'X-Idempotency-Key': idempotencyKey } });
}
/** GET /api/v1/games/:gameId/transactions — List a player's transaction history */
export async function listTransactions(ctx: TenantCtx, params: {
    limit?: number;
    offset?: number;
    type?: TxType;
...
export async function listContainerDefinitions(ctx: TenantCtx, params: ListContainerDefsParams = {}): Promise<{
    ...
    if (params.container_type)
        qs.set('container_type', params.container_type);
    if (params.q)
        qs.set('q', params.q);
    if (params.code_name)
        qs.set('code_name', params.code_name);
...
export async function createContainerDefinition(ctx: TenantCtx, body: CreateContainerDefinitionRequest): Promise<{
...
export async function getContainerDefinition(ctx: TenantCtx, definitionId: string): Promise<{
    container_definition: ContainerDefinition;
}> {
...
export async function updateContainerDefinition(ctx: TenantCtx, definitionId: string, body: UpdateContainerDefinitionRequest): Promise<{
    container_definition: ContainerDefinition;
}> {
...
export async function deleteContainerDefinition(ctx: TenantCtx, definitionId: string): Promise<{
    message: string;
}> {
...
export async function listEquipmentSlots(ctx: TenantCtx, params: ListEquipmentSlotsParams = {}): Promise<{
    slots: EquipmentSlot[];
    total: number;
}> {
    const qs = new URLSearchParams();
    ...
    if (params.slot_key)
        qs.set('slot_key', params.slot_key);
    if (params.name)
        qs.set('name', params.name);
    if (params.search)
...
export async function getEquipmentSlot(ctx: TenantCtx, slotKey: string): Promise<EquipmentSlot> {
...
export async function createEquipmentSlot(ctx: TenantCtx, body: CreateEquipmentSlotRequest): Promise<EquipmentSlot> {
    return api.post(`/api/v1/games/${ctx.gameId}/equipment-slots`, body);
}
/** PUT /api/v1/games/:gameId/equipment-slots/:slotKey */
export async function updateEquipmentSlot(ctx: TenantCtx, slotKey: string, body: UpdateEquipmentSlotRequest): Promise<EquipmentSlot> {
    return api.put(`/api/v1/games/${ctx.gameId}/equipment-slots/${slotKey}`, body);
}
/** DELETE /api/v1/games/:gameId/equipment-slots/:slotKey */
export async function deleteEquipmentSlot(ctx: TenantCtx, slotKey: string): Promise<void> {
...
export async function listItemTags(ctx: TenantCtx, params: ListItemTagsParams = {}): Promise<{
    tags: ItemTag[];
    total: number;
    limit: number;
    offset: number;
...
export async function getItemTag(ctx: TenantCtx, tagId: string): Promise<ItemTag> {
    return api.get(`/api/v1/games/${ctx.gameId}/item-tags/${tagId}`);
}
/** POST /api/v1/games/:gameId/item-tags */
export async function createItemTag(ctx: TenantCtx, body: CreateItemTagRequest): Promise<ItemTag> {
    return api.post(`/api/v1/games/${ctx.gameId}/item-tags`, body);
}
/** PUT /api/v1/games/:gameId/item-tags/:tagId */
export async function updateItemTag(ctx: TenantCtx, tagId: string, body: UpdateItemTagRequest): Promise<ItemTag> {
...
export async function deleteItemTag(ctx: TenantCtx, tagId: string): Promise<void> {
...
export async function getItemDefinitionTags(ctx: TenantCtx, itemId: string): Promise<{
    tags: ItemTag[];
}> {
    return api.get(`/api/v1/games/${ctx.gameId}/items/${itemId}/tags`);
}
/** PUT /api/v1/games/:gameId/items/:itemId/tags — assign (replace) tags */
export async function assignTagsToItemDefinition(ctx: TenantCtx, itemId: string, tag_keys: string[]): Promise<{
    tags: ItemTag[];
}> {
...
export async function removeTagsFromItemDefinition(ctx: TenantCtx, itemId: string, tag_keys: string[]): Promise<void> {
...
export async function listPresetDefinitions(ctx: TenantCtx): Promise<{
...
export async function createPresetDefinition(ctx: TenantCtx, body: CreatePresetDefinitionRequest): Promise<PresetDefinition> {
    return api.post(`/api/v1/games/${ctx.gameId}/preset-definitions`, body);
}
/** PATCH /api/v1/games/:gameId/preset-definitions/:presetId */
export async function updatePresetDefinition(ctx: TenantCtx, presetId: string, body: UpdatePresetDefinitionRequest): Promise<PresetDefinition> {
...
export async function deletePresetDefinition(ctx: TenantCtx, presetId: string): Promise<void> {
