...
export async function getCurrentSeasonRaw(gameId: string, seasonId: string): Promise<CurrentSeasonRaw> {
    const data = await api.get(`/api/v1/games/${gameId}/leaderboard-seasons/${seasonId}/rank`);
    return data;
}
// ─── Season Archive Raw ───────────────────────────────────────────────────────
...
export async function getSeasonArchive(gameId: string, seasonId: string, offset = 0, limit = 100): Promise<CurrentSeasonRaw> {
    const data = await api.get(`/api/v1/games/${gameId}/leaderboard-seasons/${seasonId}/rank?offset=${offset}&limit=${limit}`);
    return data;
}
...
export async function getSeasonRawEvents(gameId: string, seasonId: string, offset = 0, limit = 100): Promise<SeasonRawEvents> {
    const data = await api.get(`/api/v1/games/${gameId}/leaderboard-seasons/${seasonId}/raw?offset=${offset}&limit=${limit}`);
    return data;
}
...
export async function getScoreSourceTypeOptions(): Promise<ScoreSourceTypeOption[]> {
    if (_scoreSourceTypeOptionsCache)
