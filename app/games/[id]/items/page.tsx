      ...
      <Tabs id="game-items-tabs" value={activeTab} onValueChange={handleTabChange} className="space-y-4">
        ...
        <TabsContent value="catalogue" className="space-y-4">
          <ItemsPageCatalogueSection
            ...
            filterAllowClientUpdateQty={filterAllowClientUpdateQty}
            ...
            handleLinkItemToConversation={handleLinkItemToConversation}
            setSearchName={setSearchName}
            setFilterCategory={setFilterCategory}
            setFilterRarity={setFilterRarity}
            setFilterAllowClientUpdateQty={setFilterAllowClientUpdateQty}
