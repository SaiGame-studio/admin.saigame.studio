...
export default function StudioGamesPage({ params }: {
    params: Promise<{
        id: string;
    }>;
}) {
    ...
    return (<div className="container mx-auto py-6">
            ...
            {loading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                </Card>) : (<div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
                    {games.map((game) => (<Card key={game.id} className="overflow-hidden">
