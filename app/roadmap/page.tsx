...
const phases: Phase[] = [
  ...
  },
  {
    ...
    planned: [
      ...
      { name: "Leaderboard", group: "Engagement" },
      { name: "Achievement System", group: "Engagement" },
      { name: "In-App Purchase — Apple + Google Play", group: "Monetization" },
      { name: "Concurrent User Limit Enforcement", group: "Platform" },
      { name: "Game Tag System", group: "Platform" },
      { name: "Geo-Detection (Country from IP)", group: "Platform" },
      { name: "Player Journey Analytics", group: "Analytics" },
      { name: "Support Ticket System", group: "Support" },
      { name: "Email Broadcast to All Players", group: "Communications" },
      { name: "World Map System", group: "World" },
    ],
  },
  {
    number: 3,
    ...
    footnote: "Primary goal: Support 100,000+ concurrent users globally with sub-50ms response times.",
  },
  {
    number: 4,
    ...
    status: "planning",
    statusLabel: "Planning",
    footnote: "Primary goal: Enable real-time live PvP and co-op gameplay.",
  },
]
