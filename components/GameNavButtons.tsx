...
import { Store, Users, BookOpen, Mail, ScrollText, Hammer, BarChart2, Gamepad2, Trophy, ChevronsLeftRight, AlignJustify } from "lucide-react"
...
export function GameNavButtons({ gameId, active, id }: GameNavButtonsProps) {
  ...
  const items: NavItem[] = [
    ...
    { section: "shops",       href: `/games/${gameId}/shops`,       icon: <Store className="h-4 w-4" />,      label: t("game.shops") },
    { section: "items",       href: `/games/${gameId}/items`,       icon: <BookOpen className="h-4 w-4" />,   label: "Items"         },
