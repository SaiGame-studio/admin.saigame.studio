...
export function RngLootboxLink({ gameId, itemProfile, variant = "button", size = "sm", className = "" }: RngLootboxLinkProps) {
    ...
    if (variant === "link") {
        return (<Link href={url} className={`text-primary hover:text-primary/80 inline-flex items-center gap-1 ${className}`}>
