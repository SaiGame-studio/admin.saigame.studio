        ...
        {loading ? (
          ...
          <div className="space-y-5 py-2">
            ...
            <div className="rounded-lg border bg-muted/40 p-4 space-y-4">
              ...
              <UsageRow
                label="Games"
                usage={detail?.usage?.games ?? studio.game_count}
                limit={detail?.limits?.max_games}
              />
              <UsageRow
                label="Total Members"
                usage={detail?.usage?.total_members ?? 0}
                limit={detail?.limits?.max_total_members}
              />
            </div>
