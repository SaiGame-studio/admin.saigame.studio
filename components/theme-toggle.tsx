...
export function ThemeToggle() {
    ...
    return (<div className="relative flex items-center">
      ...
      <span className={`absolute right-full mr-2 whitespace-nowrap text-xs font-medium px-2 py-0.5 rounded bg-popover border border-border shadow-sm text-foreground pointer-events-none transition-all duration-300 ${showLabel ? "opacity-100 translate-x-0" : "opacity-0 translate-x-2"}`}>
