...
export function SupportChatWidget() {
  ...
  return <div id="support-chat-widget" className="fixed bottom-[30px] right-5 z-30 flex w-80 flex-col items-end">
