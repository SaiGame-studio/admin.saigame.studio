...
export function RegisterForm() {
    ...
    useEffect(() => {
        const updateWidth = () => {
            ...
            if (vw < 360)
                setGoogleBtnWidth("260");
            else if (vw < 400)
                setGoogleBtnWidth("280");
            else
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardContent className="space-y-3 pb-3">
          ...
          <div className="space-y-2">
            ...
            <Input id="username" type="text" placeholder="your_username" value={username} onChange={(e) => setUsername(e.target.value)} required disabled={isLoading}/>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="password-confirmation" type="password" placeholder="••••••••" value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} required disabled={isLoading}/>
          </div>
        </CardContent>
        <CardFooter className="flex flex-col space-y-3 pt-0">
          ...
          {googleClientId && (<>
              ...
              <div className="flex justify-center w-full overflow-hidden">
                <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => setError("Google sign-in failed. Please try again.")} theme="outline" size="large" width={googleBtnWidth} text="signup_with" shape="rectangular"/>
              </div>
            </>)}
